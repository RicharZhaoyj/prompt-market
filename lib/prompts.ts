...
export const CATEGORIES: Category[] = [
  ...
  { id: 'cat_02', name: '编程', emoji: '💻', prompt_count: 11, description: '代码生成、调试、架构设计' },
  { id: 'cat_03', name: '设计', emoji: '🎨', prompt_count: 5, description: 'UI/UX、图像生成、视觉设计' },
  ...
  { id: 'cat_07', name: '商业', emoji: '💼', prompt_count: 6, description: '创业、职场、商业计划' },
